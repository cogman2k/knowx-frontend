...
const ListComment = () => {
  ...
  async function getListComment() {
    ...
    try {
      const response = await fetch(
        `https://knowx-fe.herokuapp.com/api/user/questions/comment/get`,
        requestOptions
      );
  ...
  async function createComment() {
    ...
    setTimeout(async () => {
      try {
        const response = await fetch(
          `https://knowx-fe.herokuapp.com/api/user/questions/comment/create`,
          requestOptions
        );
        const responseJSON = await response.json();
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://knowx-fe.herokuapp.com/api/user/questions/comment/delete`,
        requestOptions
      );
      const responseJSON = await response.json();
            ...
            <div style={{ display: "flex" }}>
              <li>
                <Comment
                  ...
                  avatar={`https://knowx-fe.herokuapp.com/${item.image}`}
